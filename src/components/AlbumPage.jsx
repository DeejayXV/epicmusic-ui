...
const AlbumPage = ({ playTrack }) => {
  ...
  return (
    <div className="album-details">
      <button onClick={() => window.history.back()} className="back-button" style={{ borderRadius: '50%', backgroundColor: '#d3d3d3', border: 'none', width: '40px', height: '45px', cursor: 'pointer', marginBottom:'10px', color:'black' }}> &lt; </button>
